            ...
            <div class='col-lg-12'>
                ...
                <div class="card">
                    <div class="card-body">
                      ...
                      <!-- Vertical Form -->
                      <form class="row g-3" action="{{ route('vendor.store') }}" enctype="multipart/form-data" method="POST">
                        @csrf
                        <div class="col-12">
                          <label for="inputNanme4" class="form-label">Nama Vendor</label>
                          <input type="text" class="form-control @error('nama_vendor') is-invalid @enderror"  name="nama_vendor">
                          @error('nama_vendor')
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control @error('badan_hukum') is-invalid @enderror"  name="badan_hukum">
                            @error('badan_hukum')
                              <div class='invalid-feedback'>{{ $message }}</div>
                            @enderror
                          </div>
